...
class REPL:
    ...
    def REPL(self, stream = sys.stdin, suppress = False) -> None:
        ...
        if suppress: 
            ...
            else: print(f"--- ALVIN v{INT.interpreter.VERSION} ---")
    ...
    def interpret(self, expr: str) -> str | Text:
        ...
        return PAR.toALVIN(EVA.evaluate(PAR.parse(expr)))
...
##### Helper Functions #####
    ...
    def welcome(self) -> Text:
        ...
        if INT.interpreter.iFlag: 
            msg += f"ALVIN v{INT.interpreter.VERSION}, [{INT.interpreter.DEFAULT_COLOR}]interactive[/]"
    ...
    def help(self) -> Panel:
        ...
        msg = f"""ALVIN is an experimental programming language.
