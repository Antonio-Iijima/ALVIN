...
class Closable:
    """Parent class for all ALVIN structures supporting closures, i.e. functions and templates."""
...
class Function(Closable):
    ...
    def __init__(self, name: str, parameters: list = None, body: list = None, isMethod: bool = False, isLazy: bool = False) -> None:
        ...
        if self.type == "lambda": self.name = f"{PAR.toALVIN(self.parameters)} {PAR.toALVIN(self.body)}" 
